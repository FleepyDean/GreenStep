        ...
        <footer class="guidelines-section" style="margin-top: 30px;">
          ...
          <div class="guidelines-grid">
            <div class="guide-item">
              <svg class="guide-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="5.5" cy="17.5" r="3.5"/><circle cx="18.5" cy="17.5" r="3.5"/><path d="M15 6h3v8h-3zM8 6h3v8H8zM11 10h4"/></svg>
              <h5>Transport</h5>
              <p>Log your total travel distance in different transport modes.</p>
            </div>
            <div class="guide-item">
              <svg class="guide-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a7 7 0 0 0-7 7c0 3 2 5 2 8h10c0-3 2-5 2-8a7 7 0 0 0-7-7z"/><path d="M9 21h6"/><path d="M10 17v4M14 17v4"/></svg>
              <h5>Diet</h5>
              <p>Track your meals. Red meat heavily affects footprint calculations.</p>
            </div>
            <div class="guide-item">
              <svg class="guide-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
              <h5>Energy</h5>
              <p>Monitor domestic electricity and appliance energy consumption.</p>
            </div>
            <div class="guide-item">
              <svg class="guide-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M3 21v-5h5"/></svg>
              <h5>Recycling</h5>
